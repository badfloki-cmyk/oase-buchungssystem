...
import { users, rooms, bookings, messages, type User, type InsertUser, type Room, type Booking, type InsertBooking, type Message, type InsertMessage } from "@shared/schema";
